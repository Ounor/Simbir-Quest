...
import (
	"github.com/Ounor/Simbir-Quest/internal/assets"
...
const (
	fontFaceRegular = "files/fonts/NotoSans-Regular.ttf"
	fontFaceBold    = "files/fonts/NotoSans-Bold.ttf"
)
...
func loadFont(path string, size float64) (font.Face, error) {
	fontData, err := assets.EmbeddedAssets.ReadFile(path)
	if err != nil {
		return nil, err
	}
...
func loadFontTTF(size float64) (font.Face, error) {
